...
let EventsController = EventsController_1 = class EventsController {
            ...
            where: [
                {
                    ...
                    when: (0, typeorm_1.MoreThan)(new Date('2021-02-12T13:00:00')),
                },
                {
    ...
    async update(id, input) {
        const event = await this.repository.findOne(id);
        return await this.repository.save(Object.assign(Object.assign(Object.assign({}, event), input), { when: input.when ? new Date(input.when) : event.when }));
    }
...
__decorate([
    (0, common_1.Get)('practice/loading-relations'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], EventsController.prototype, "practice2", null);
__decorate([
    (0, common_1.Get)('practice/find-event-and-replace-attendee-with-cascade'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], EventsController.prototype, "practice3", null);
__decorate([
    (0, common_1.Get)(':id'),
