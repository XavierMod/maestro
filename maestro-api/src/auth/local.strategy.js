...
var LocalStrategy = /** @class */ (function (_super) {
    ...
    function LocalStrategy(userRepository) {
        ...
        _this.logger = new common_1.Logger(LocalStrategy_1.name);
        return _this;
    }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        console.log('getting');
                        if (!user) {
                            this.logger.debug("User ".concat(username, " not found!"));
                            throw new common_1.UnauthorizedException(["User ".concat(username, " not found!")]);
                        }
                        return [4 /*yield*/, bcrypt.compare(password, user.password)];
                    case 2:
                        if (!(_a.sent())) {
                            this.logger.debug("Invalid credentials for user ".concat(username));
                            throw new common_1.UnauthorizedException(["Invalid credentials for user ".concat(username)]);
                        }
