...
var UsersController = /** @class */ (function () {
    function UsersController(repository, authService) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        users = _a.sent();
                        this.logger.debug("Found ".concat(users.length, " users"));
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        ...
                        _a = user;
                        return [4 /*yield*/, this.authService.hashPassword(createUserDto.password)];
                    case 2:
                        _a.password = _c.sent();
                        user.email = createUserDto.email;
                        _b = [{}];
                        return [4 /*yield*/, this.repository.save(user)];
                    case 3: return [2 /*return*/, __assign.apply(void 0, [__assign.apply(void 0, _b.concat([(_c.sent())])), { token: this.authService.getTokenForUser(user) }])];
                }
            });
        });
    };
